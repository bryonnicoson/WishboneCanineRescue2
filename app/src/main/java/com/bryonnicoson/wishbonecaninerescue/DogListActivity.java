...
import com.bryonnicoson.wishbonecaninerescue.dummy.DummyContent;
...
public class DogListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.dog_list);
        assert recyclerView != null;
        setupRecyclerView((RecyclerView) recyclerView);

        if (findViewById(R.id.dog_detail_container) != null) {
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(DogDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        DogDetailFragment fragment = new DogDetailFragment();
                        fragment.setArguments(arguments);
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.dog_detail_container, fragment)
                                .commit();
                    } else {
                        Context context = v.getContext();
                        Intent intent = new Intent(context, DogDetailActivity.class);
                        intent.putExtra(DogDetailFragment.ARG_ITEM_ID, holder.mItem.id);
